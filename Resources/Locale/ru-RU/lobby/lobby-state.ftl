...
lobby-state-soon = Раунд когда-то начнётся
...
lobby-state-ready-button-join-state = В бой!
...
lobby-state-player-status-observer = Куколд
lobby-state-player-status-round-not-started = Раунд пока не начался
