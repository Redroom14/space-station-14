permissions-eui-do-not-have-required-flags-to-edit-admin-tooltip = У вас нет необходимых флагов для редактирования этого Лорда.
...
permissions-eui-menu-add-admin-button = Добавить Лорда
permissions-eui-menu-add-admin-rank-button = Добавить ранг Лорда
permissions-eui-menu-save-admin-rank-button = Сохранить
permissions-eui-menu-remove-admin-rank-button = Удалить
permissions-eui-menu-admins-tab-title = Лорды
permissions-eui-menu-admin-ranks-tab-title = Ранги Лордов
permissions-eui-edit-admin-window-edit-admin-label = Редактировать Лорда { $admin }
...
permissions-eui-edit-admin-rank-window-title = Редактирование рангов Лордов
